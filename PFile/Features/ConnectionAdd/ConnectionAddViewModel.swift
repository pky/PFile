...
@Observable
final class ConnectionAddViewModel {

    var displayName = ""
    var serviceType: ServiceType = .smb
    var host = ""
    var port = ""
    var username = ""
    var password = ""
    ...
    func save() async throws {
        ...
        let connection = RemoteConnection(
            ...
            host: host,
            port: Int(port) ?? serviceType.defaultPort,
        ...
        try await remoteConnectionRepository.save(connection)
    }
